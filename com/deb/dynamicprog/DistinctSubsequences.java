...
(1) We store the positions of each letter of T in S, in a table:
     ...
     a [0, 1]
     b [2, 3]
(2) The problem then can be viewed as "find how many paths from top to the bottom with an 
ascending order".  In other words, from the table above, for "a" we have only one choice 0,  
the other "a" we have only one choice 1, and for b we can choose 2 or 3, thus the result is 2.
 */
